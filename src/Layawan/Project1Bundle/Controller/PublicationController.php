...
namespace Layawan\Project1Bundle\Controller;
...
use Layawan\Project1Bundle\Entity\Publication;
use Layawan\Project1Bundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LayawanProject1Bundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("LayawanProject1Bundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LayawanProject1Bundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LayawanProject1Bundle:Publication:edit.html.twig")
     */
