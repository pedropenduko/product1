...
use Layawan\Project1Bundle\Entity\Issue;
use Layawan\Project1Bundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LayawanProject1Bundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("LayawanProject1Bundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LayawanProject1Bundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LayawanProject1Bundle:Issue:edit.html.twig")
     */
